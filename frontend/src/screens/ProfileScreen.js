                                ...
                                <>
                                    ...
                                    <div>
                                        ...
                                        <input id="sellerName" type="text"  
                                            placeholder="Enter Seller Name" value={sellerName}
                                    ...
                                    <div>
                                        ...
                                        <input id="sellerLogo" type="text"  
                                            placeholder="Enter Seller Logo" value={sellerLogo}
                                    ...
                                    <div>
                                        ...
                                        <input id="sellerDescription" type="text"  
                                            placeholder="Enter Seller Description" value={sellerDescription}
